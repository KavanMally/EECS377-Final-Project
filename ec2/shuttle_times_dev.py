...
def get_time_to_arrival():
    ...
    print(dd["Bellflower & Ford"][0])
    return dd

# todo mqttt
# loop forever, publish shutle times ever 10 seconds
...
mqtt.connect("localhost", 50001, 3600)

sleep(0.5)

while True:
    dd = get_time_to_arrival()
    mqtt.publish("/devices/b827eb679fe8/sparti/transport/bus_schedule", payload=json.dumps(dd))
    sleep(10)
